...
const AddTicketForm = () => {
  ...
  return (
    <div className="w-[487px] h-[615.08px] top-[204px] left-[477px] p-8 rounded-lg border border-solid border-gray-300 mx-auto my-auto bg-white shadow-md mb-8 flex flex-col mt-9">
